...
-- ----------------------------
INSERT INTO `sys_announcement_send` VALUES ('646c0c405ec643d4dc4160db2446f8ff', '93a9060a1c20e4bf98b3f768a02c2ff9', 'e9ca23d68d884d4ebb19d07889727dae', '1', '2019-11-26 15:49:23', 'admin', '2019-05-17 11:50:56', 'admin', '2019-11-26 15:49:23');
INSERT INTO `sys_announcement_send` VALUES ('fe830d183c1c031108f2efce63cfe96f', '93a9060a1c20e4bf98b3f768a02c2ff9', 'a75d45a015c44384a04449ee80dc3503', '0', NULL, 'jeecg', '2019-11-01 11:50:43', NULL, NULL);
...
INSERT INTO `sys_log` VALUES ('e55391652db3c2a0b27f4e39dc688b3e', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-01 11:50:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('db30ca2e42382615b193984fff054189', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-01 11:50:39', NULL, NULL);
INSERT INTO `sys_log` VALUES ('8f122521897a44136b8a4cfc995880a3', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-01 14:12:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('67ef9fbb10025f18dfe174a67f8528e1', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-08 18:03:07', NULL, NULL);
INSERT INTO `sys_log` VALUES ('5f0c4a3646f946fbcf37073ef187b2bf', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-11 10:13:59', NULL, NULL);
INSERT INTO `sys_log` VALUES ('121f61445a5617ef5a89d0356090f4f9', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-11 10:14:45', NULL, NULL);
INSERT INTO `sys_log` VALUES ('b69c3adfe89ca4908132f92f44759a0c', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-11 10:17:16', NULL, NULL);
INSERT INTO `sys_log` VALUES ('97a00e08491268c237cc2238e4371b95', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-11 10:17:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('7d1b9a8a1320793d53b599b405128f1f', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 11:34:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('acb08eb3352cd2b7b821e94f1ba6a8a0', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 11:36:01', NULL, NULL);
INSERT INTO `sys_log` VALUES ('ddca51b4edf7d979c5e8f14140f1bae5', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 11:36:52', NULL, NULL);
INSERT INTO `sys_log` VALUES ('de61a92f5b4a5bde13b89c70818f2f45', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 13:43:07', NULL, NULL);
INSERT INTO `sys_log` VALUES ('430e868f0f8852e2ce47193f60ae4178', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-13 13:43:32', NULL, NULL);
INSERT INTO `sys_log` VALUES ('39e1fa6a97d7b44d99a801ca16817d5e', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-14 16:23:55', NULL, NULL);
INSERT INTO `sys_log` VALUES ('13edfe3a1141f17d8db1331f65094515', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-21 16:00:33', NULL, NULL);
INSERT INTO `sys_log` VALUES ('093e369eb7adccf1115c92c639e14f5f', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-21 16:41:52', NULL, NULL);
INSERT INTO `sys_log` VALUES ('848b26e1fe38aa3bc1e5a63b5ab20bb8', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-26 15:17:30', NULL, NULL);
INSERT INTO `sys_log` VALUES ('53594910e38f678968c00eaadde37864', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-26 15:18:30', NULL, NULL);
INSERT INTO `sys_log` VALUES ('97a3f0acb569f92678bffd93994ff00d', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-26 15:27:47', NULL, NULL);
INSERT INTO `sys_log` VALUES ('a838bbd697936231ef7dd8b83c41ca2a', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-11-26 15:40:22', NULL, NULL);
INSERT INTO `sys_log` VALUES ('c0c8849dc7e01f09b8c778485526d82e', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 16:45:04', NULL, NULL);
INSERT INTO `sys_log` VALUES ('6d2d9fd9142d65b91665b8c0c6ac546c', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 16:57:08', NULL, NULL);
INSERT INTO `sys_log` VALUES ('71e88166268b5c1e2700ed7d3da6c101', 2, '微信文章-分页列表查询', 1, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', 'com.cake.modules.wechat.controller.WechatArticleController.queryPageList()', NULL, NULL, NULL, 136, 'jeecg', '2019-12-04 16:57:57', NULL, NULL);
INSERT INTO `sys_log` VALUES ('6f76430517561be93675f93095bd0399', 2, '微信文章-分页列表查询', 1, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', 'com.cake.modules.wechat.controller.WechatArticleController.queryPageList()', NULL, NULL, NULL, 3, 'jeecg', '2019-12-04 16:58:51', NULL, NULL);
INSERT INTO `sys_log` VALUES ('5dc53284ea6618ffd0baf28cb1fbc21a', 2, '微信账户-添加', 2, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', 'com.cake.modules.wechat.controller.WechatAccountController.add()', NULL, '[{\"account\":\"大佬\",\"aeskey\":\"icake\",\"appid\":\"12345677\",\"appsecret\":\"123443455\",\"createBy\":\"大佬\",\"createTime\":1575450120000,\"id\":0,\"name\":\"hhh\",\"qrUrl\":\"ddddd\",\"token\":\"adsdsfdsfds\",\"updateBy\":\"sdsfsfd\",\"url\":\"\"}]', NULL, 464, 'jeecg', '2019-12-04 17:01:33', NULL, NULL);
INSERT INTO `sys_log` VALUES ('518b72cc6ae821ada09ad3f10bbf4ce1', 2, '微信账户-分页列表查询', 1, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', 'com.cake.modules.wechat.controller.WechatAccountController.queryPageList()', NULL, NULL, NULL, 165, 'jeecg', '2019-12-04 17:01:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('6dd123e87a6b45a794aff26ec1e7b2da', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 18:02:28', NULL, NULL);
INSERT INTO `sys_log` VALUES ('b7385b5e1debdcbf0d32fd111d3bd3c5', 2, '微信账户-分页列表查询', 1, 'jeecg', 'jeecg', '0:0:0:0:0:0:0:1', 'com.cake.modules.wechat.controller.WechatAccountController.queryPageList()', NULL, NULL, NULL, 17, 'jeecg', '2019-12-04 18:03:13', NULL, NULL);
INSERT INTO `sys_log` VALUES ('6e92cf395f7723e11f154193c105ccf3', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 18:07:00', NULL, NULL);
INSERT INTO `sys_log` VALUES ('9741be90410267dcdccfb93daa65a64c', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 18:07:12', NULL, NULL);
INSERT INTO `sys_log` VALUES ('80d5751c0e65d0c0cbb12e23f00c2b6a', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, NULL, 'jeecg', '2019-12-04 18:07:20', NULL, NULL);
...
CREATE TABLE `sys_role_wxaccount`  (
  ...
  `role_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色ID',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限资源-角色微信账户关联表 ' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user` VALUES ('a75d45a015c44384a04449ee80dc3503', 'jeecg', 'jeecg', '31a7cb762d944bf6', 'vDDkDzrK', 'user/20190220/e1fe9925bc315c60addea1b98eb1cb1349547719_1550656892940.jpg', NULL, 2, NULL, NULL, 'A02A01', 1, 0, 1, 'admin', '2019-02-13 16:02:36', 'admin', '2019-04-09 15:47:36');
INSERT INTO `sys_user` VALUES ('e9ca23d68d884d4ebb19d07889727dae', 'admin', '管理员', 'ac04b5d78a985942', 'RCGTeGiH', 'user/20190119/logo-2_1547868176839.png', '2018-12-05 00:00:00', 1, '11@qq.com', '18566666661', 'A01', 1, 0, 1, NULL, '2038-06-21 17:54:10', 'admin', '2019-07-05 14:47:22');
...
CREATE TABLE `wx_account`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号名称',
  `account` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号账户',
  `appid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号appid',
  `appsecret` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号密钥',
  `url` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号url',
  `token` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公众号token',
  `aeskey` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '加密密钥',
  `qr_url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '二维码图片URL',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '公众号账户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wx_account
-- ----------------------------
INSERT INTO `wx_account` VALUES (3, 'hhh', '大佬', '12345677', '123443455', '', 'adsdsfdsfds', 'icake', 'ddddd', '大佬', '2019-12-04 17:02:00', 'sdsfsfd', NULL);
...
CREATE TABLE `wx_account_fans`  (
  ...
  `openid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户标识',
  `subscribe_status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订阅状态，0未关注，1已关注',
  `subscribe_time` datetime(0) NULL DEFAULT NULL COMMENT '订阅时间',
  `nickname` varbinary(2000) NULL DEFAULT NULL COMMENT '昵称',
  `gender` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '性别，1男，2女，0未知',
  `language` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '语言',
  ...
  `headimg_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像地址',
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信公众号ID',
  `wx_account_appid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信公众号appid',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信公众号粉丝表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_account_fans_tag
-- ----------------------------
...
CREATE TABLE `wx_account_fans_tag`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '粉丝标签关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_fans_msg`  (
  ...
  `headimg_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像地址',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `msg_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '消息类型',
  `content` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内容',
  `res_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '最近一条回复内容',
  `is_res` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否已回复',
  `media_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信素材ID',
  `pic_url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信图片URL',
  `pic_path` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '本地图片路径',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '粉丝消息表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_fans_msg_res`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `fans_msg_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '粉丝消息ID',
  `res_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '回复内容',
  `user_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户ID',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回复粉丝消息历史表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_fans_tag`  (
  ...
  `count` int(11) NULL DEFAULT NULL COMMENT '粉丝数量',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '粉丝标签表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_media_upload
-- ----------------------------
...
CREATE TABLE `wx_media_upload`  (
  ...
  `url` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片URL',
  `media_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '素材ID',
  `thumb_media_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '缩略图素材ID',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信素材上传表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_menu`  (
  ...
  `menu_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单类型 1文本消息；2图文消息；3网址链接；4小程序',
  `menu_level` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单等级',
  `tpl_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板ID',
  `menu_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单URL',
  `menu_sort` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '排序',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `miniprogram_appid` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '小程序appid',
  `miniprogram_pagepath` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '小程序页面路径',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信菜单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_news_article_item
-- ----------------------------
...
CREATE TABLE `wx_news_article_item`  (
  ...
  `digest` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '摘要',
  `author` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '作者',
  `show_cover_pic` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否展示封面图片（0/1）',
  `thumb_media_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上传微信，封面图片标识',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `content_source_url` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内容链接',
  `order_no` int(11) NULL DEFAULT NULL COMMENT '文章排序',
  `pic_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片路径',
  `need_open_comment` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否可以留言',
  `only_fans_can_comment` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否仅粉丝可以留言',
  `news_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图文ID',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图文消息文章列表表 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_news_template
-- ----------------------------
DROP TABLE IF EXISTS `wx_news_template`;
CREATE TABLE `wx_news_template`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键 主键ID',
  `tpl_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板名称',
  `is_upload` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否已上传微信',
  `media_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图文消息模板表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_receive_text
-- ----------------------------
DROP TABLE IF EXISTS `wx_receive_text`;
CREATE TABLE `wx_receive_text`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `receive_text` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '关键字',
  `msg_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '消息类型 1文本消息；2图文消息；',
  `tpl_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板ID',
  `wx_account_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信账号ID',
  `create_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回复关键字表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for wx_subscribe_text
-- ----------------------------
...
CREATE TABLE `wx_subscribe_text`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '关注欢迎语表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wx_text_template`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tpl_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板名字',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文本模板表' ROW_FORMAT = Dynamic;
