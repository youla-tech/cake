...
/**
 * @Description: wechat  recevie text
 * @Author: eamiear
 * @Date:   2019-12-04
 * @Version: V1.0
 */
...
@ApiModel(value="wx_receive_text对象", description="wechat  recevie text")
public class WechatReceiveText {
  ...
  @ApiModelProperty(value = "关键字")
	private java.lang.String receiveText;
	/**模板ID*/
